package com.android.mobileplayer.adapter;
...
public class VideoPagerAdapter extends BaseAdapter {
    ...
    public VideoPagerAdapter(Context context, ArrayList<MediaItem> datas) {
        this.context = context;
        this.mediaItems = datas;
        utils = new Utils();
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ViewHoder viewHoder;
        if(convertView ==null){
            convertView = View.inflate(context, R.layout.item_vide_pager,null);
